...
\begin{abstract}
I propose to consider the question, ``Can machines think?'' This paper introduces the imitation game as a replacement for the original question, discusses the main objections to the possibility of machine thought, and outlines an approach based on learning machines.
\end{abstract}
...
\section{Critique of the New Problem}
...
\section{The Machines Concerned in the Game}
...
\section{Universality of Digital Computers}
...
\section{Contrary Views on the Main Question}
...
\subsection{The "Heads in the Sand" Objection}
...
\subsection{The Mathematical Objection}
...
\subsection{The Argument from Consciousness}
...
\subsection{Arguments from Various Disabilities}
...
\subsection{Lady Lovelace's Objection}
...
\subsection{Argument from Continuity in the Nervous System}
...
\subsection{The Argument from Informality of Behaviour}
...
\subsection{The Argument from Extrasensory Perception}
...
\item Other experience, not to be described as education, to which it has been subjected.\end{itemize}
...
\item Natural selection $=$ judgment of the experimenter\end{itemize}
