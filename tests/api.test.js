...
test('Frontend exposes outline and layered writing context controls', async () => {
  const html = await (await fetch(baseUrl + '/')).text();
  assert.ok(html.includes('id="outline-tree"'));
  assert.ok(html.includes('id="context-summary"'));
  assert.ok(html.includes('id="context-prompt"'));
  assert.ok(html.includes('id="context-intent"'));
  ...
  assert.ok(!html.includes('id="ai-action"'));
  assert.ok(html.includes('id="ai-invoke"'));
  assert.ok(html.includes('>请神</button>'));
  assert.ok(html.includes('id="invoke-confirm-overlay"'));
  assert.ok(html.includes('id="invoke-confirm"'));
  assert.ok(html.includes('id="focus-annotation-open"'));
  ...
  assert.ok(html.includes('id="paragraph-draft"'));
  ...
  assert.ok(html.includes('id="workspace-view-switch"'));
  assert.ok(html.includes('id="source-view-btn"'));
  assert.ok(html.includes('id="preview-view-btn"'));
  assert.ok(html.includes('id="pdf-preview" aria-label="Rendered PDF pages"'));
  assert.ok(html.includes('type="module" src="/app.js"'));
  assert.ok(html.indexOf('id="preview-panel"') < html.indexOf('id="right-panel"'));
  assert.ok(html.indexOf('id="ai-panel"') > html.indexOf('id="right-panel"'));
